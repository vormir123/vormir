...
import { isFunction } from "@vormir/util/typecheck";
import { getCookie } from "@vormir/util/cookie";
...
const initClient = params => {
    ...
    const guardedReduxState = reduxState || window.__data,
        ...
        guardedLang =
            ...
            "en-US",
        guardedRootDiv = rootDiv || "vormir-root",
        swScript = document.querySelectorAll("link[data-vormir-sw-script]");
