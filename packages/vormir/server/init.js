...
import routes from "@vormir/route";
import { isArray, isFunction } from "@vormir/util/typecheck";
...
/**
 * A function to create helper in vormir server.
 * @param app vormir server instance
...
/**
 * A function to create middleware in vormir server.
 * @param app vormir server instance
...
const initMiddleware = (app, customMiddlewares) => {
    ...
    if (process.env.NODE_ENV === "development") {
        ...
        app.use("/__vormir_WDS__", global.__WDS_PROXY);
    }
...
/**
 * A function to create renderer in vormir server.
 * @param app vormir server instance
...
/**
 * A function to create server for vormir.
